...
import com.android.nikichat.ui.FriendsFragment;
import com.android.nikichat.ui.GroupFragment;
import com.android.nikichat.ui.LoginActivity;
import com.android.nikichat.ui.UserProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(toolbar != null) {
            ...
            getSupportActionBar().setTitle("Niki Chat");
        }
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "Made by Surbhit Rao", Toast.LENGTH_LONG).show();
            return true;
        }
